BZFlag Server Plugin: skyfireFlag
================================================================================
...
skyfireFlag directory to a new name, and then manually replace skyfireFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin skyfireFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin skyfireFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin skyfireFlag,<configfilename>
For example:
  -loadplugin skyfireFlag,/path/to/my/sampleplugin.cfg
